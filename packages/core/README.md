...
codegraphy impact src/plugins/registry.ts --depth 2
codegraphy edges
...
- Impact Query: traverse bounded incoming Relationships from one exact target and report impacted Files with shortest distance and Edge Types.
