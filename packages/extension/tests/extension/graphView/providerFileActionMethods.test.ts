...
describe('graphView/providerFileActionMethods', () => {
  afterEach(() => {
    vi.doUnmock('vscode');
    vi.doUnmock('../../../src/extension/graphView/providerFileNavigation');
...
async function createDefaultDependencyHarness() {
  ...
  vi.doMock('../../../src/extension/graphView/providerFileNavigation', () => ({
  ...
  const { createGraphViewProviderFileActionMethods: createMethods } = await import(
    '../../../src/extension/graphView/providerFileActionMethods'
  );
