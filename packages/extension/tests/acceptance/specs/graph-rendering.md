...
And the src/index.ts node has an edge that points to the src/format.ts node
And the src/index.ts node has an edge that points to the src/rollout.ts node
