...
export function PluginCard({
  ...
  return (
    <Card as="article" className="rounded-3xl bg-card/75" id={plugin.id} interactive>
      <CardContent className="flex h-full flex-col p-5">
        <div className="flex items-center gap-3">
          <span className="grid size-12 shrink-0 place-items-center rounded-2xl bg-secondary"><Icon className="size-7" src={plugin.iconUrl} /></span>
        ...
        {plugin.media ? (
          <MediaImage
            className="mt-4 h-44 rounded-2xl border border-border bg-secondary transition-[height] duration-500 ease-in-out hover:h-64"
            fill
