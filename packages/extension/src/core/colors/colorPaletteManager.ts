...
import { normalizeExtension } from './colorExtensionUtils';
import { resolveColor, resolveColorInfo } from './colorResolverLookup';
import { classifyAndSetColors, mergeColors } from './colorClassification';
import type { IColorInfo, IColorGenerationOptions } from './colorPaletteTypes';

export { DEFAULT_FALLBACK_COLOR } from './colorPaletteTypes';
export type { ColorSource, IColorInfo, IColorGenerationOptions } from './colorPaletteTypes';
