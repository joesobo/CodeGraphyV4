...
import { createGraphViewProviderViewSelectionMethods } from '../../../../src/extension/graphView/provider/viewSelection';

describe('graphView/provider/viewSelection default dependencies', () => {
  beforeEach(() => {
