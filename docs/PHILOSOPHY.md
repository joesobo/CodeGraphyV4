...
Today that built-in baseline covers JavaScript, TypeScript, TSX, Python, Go, Java, Rust, C#, C, and C++.
...
- Python, Go, Java, Rust, C#, C, and C++: built-in Tree-sitter analysis finds baseline imports, symbols, and low-noise structural relationships, plugins can add richer project-aware semantics
