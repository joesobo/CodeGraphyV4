...
import { assembleSvg, createBaseParts, createDefinitions, getPalette } from '../../../../src/webview/lib/export/svgDocument';
import type { SvgExportOptions } from '../../../../src/webview/lib/export/svgTypes';
