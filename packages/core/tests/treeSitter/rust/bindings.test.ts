...
import { getIdentifierText, getLastPathSegment } from '../../../src/treeSitter/runtime/analyze/nodes';
...
describe('pipeline/plugins/treesitter/runtime/analyzeRust/bindings', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
