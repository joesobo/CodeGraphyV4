...
codegraphy triage 'offline graph document sizing physics'
...
- Workspace Triage: fuse independent task terms into a paginated File ranking weighted by lexical rarity, graph degree, production-source preference, and source-area coverage.
