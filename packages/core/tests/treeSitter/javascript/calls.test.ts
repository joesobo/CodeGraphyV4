...
import { handleJavaScriptCallExpression } from '../../../src/treeSitter/runtime/analyzeJavaScript/calls';
import {
  getImportedBindingByIdentifier,
  getImportedBindingByPropertyAccess,
} from '../../../src/treeSitter/runtime/analyze/imports';
import { getImportRelationForJavaScriptCallExpression } from '../../../src/treeSitter/runtime/analyzeJavaScript/callImports';
import { addCallRelation } from '../../../src/treeSitter/runtime/analyze/results';
...
vi.mock('../../../src/treeSitter/runtime/analyzeJavaScript/callImports', () => ({
