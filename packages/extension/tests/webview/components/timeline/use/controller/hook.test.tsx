...
import * as playbackAnimationModule from '../../../../../../src/webview/components/timeline/use/controller/playback/playbackAnimation';
...
vi.mock('../../../../../../src/webview/components/timeline/use/controller/playback/playbackAnimation', async () => {
  const actual = await vi.importActual<
    typeof import('../../../../../../src/webview/components/timeline/use/controller/playback/playbackAnimation')
  >('../../../../../../src/webview/components/timeline/use/controller/playback/playbackAnimation');
