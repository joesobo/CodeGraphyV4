...
import { addDecorationEntry, clearPluginEntries } from './decorationStorage';
import type { NodeDecoration, EdgeDecoration, DecorationEntry } from './decorationTypes';

export type { NodeDecoration, EdgeDecoration, TooltipSection, DecorationEntry } from './decorationTypes';
