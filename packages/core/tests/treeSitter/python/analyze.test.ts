...
import { analyzePythonFile } from '../../../src/treeSitter/runtime/analyzePython/file';
...
vi.mock('../../../src/treeSitter/runtime/analyzePython/imports', () => ({
  handlePythonImportStatement,
  handlePythonImportFromStatement,
}));

vi.mock('../../../src/treeSitter/runtime/analyzePython/symbols', () => ({
  handlePythonCall,
  handlePythonClassDefinition,
  handlePythonFunctionDefinition,
}));
