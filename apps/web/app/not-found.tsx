...
export default function NotFound(): React.ReactElement {
  return (
    <section className="mx-auto grid min-h-[70svh] w-full max-w-384 place-items-center px-5 py-20 sm:px-8 lg:px-12">
      <div className="w-full max-w-4xl py-14 text-center">
        ...
        <h1 className="home-display mt-4 text-6xl leading-none sm:text-8xl">Relationship not found.</h1>
