...
export function resolveProjectedEndpoint(
  nodeId: string,
...
export function mergeProjectedEdge(edges: Map<string, IGraphEdge>, edge: IGraphEdge): void {
...
export function mergeEdgeSources(
