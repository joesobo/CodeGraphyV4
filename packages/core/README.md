...
- Graph Cache storage: load, save, clear, and inspect normalized File, Node, NodeType, EdgeType, Symbol, and Relation rows in the SQLite-backed Graph Cache at `<workspace-root>/.codegraphy/graph.sqlite`.
