        ...
        fileAnalysis: new Map([
          ['src/source.ts', {
            ...
            relations: [{
              ...
              sourceId: 'es6-import',
              from: { kind: 'symbol', symbolId: 'source-symbol', filePath: '/workspace/src/source.ts' },
              target: { kind: 'symbol', symbolId: 'target-symbol', filePath: '/workspace/src/target.ts' },
            }],
          }],
          ['src/target.ts', {
          ...
          ['src/source.ts', {
            ...
            relations: [
              ...
              },
              {
                ...
                from: { kind: 'symbol', symbolId: 'source-symbol', filePath: '/workspace/src/source.ts' },
                target: { kind: 'unresolved', specifier: 'missing-reference' },
              },
            ],
          }],
          ['src/target.ts', {
