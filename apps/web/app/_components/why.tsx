...
export function Why(): React.ReactElement {
  return (
    <section className="w-full bg-[#dce8e4] px-5 py-24 text-[#102634] dark:bg-[#0b2530] dark:text-white sm:px-8 sm:py-32 lg:px-12">
      <div className="mx-auto max-w-[90rem]">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-7 text-base leading-7 text-[#49636a] dark:text-white/62 sm:text-lg">
          ...
          <p className="mt-4 text-base leading-7 text-[#49636a] dark:text-white/62 sm:text-lg">
        ...
        <div className="mx-auto mt-14 grid max-w-6xl gap-6 border-t border-[#102634]/12 pt-10 text-left dark:border-white/12 sm:grid-cols-3">
          {reasons.map((reason) => (
            <div key={reason.title}>
              <span className="flex size-11 items-center justify-center rounded-full bg-[#f2f1eb] text-[#087f79] dark:bg-white/8 dark:text-[#61d8ca]">
