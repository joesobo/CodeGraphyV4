...
export const TYPE_LIKE_SYMBOL_GROUPS: SymbolDefaultGroup[] = [
  { id: 'default:symbol-kind:include', displayLabel: 'Include', color: '#38BDF8', imageUrl: createMaterialSymbolIconDataUrl(mdiPound), matchNodeType: 'symbol', matchSymbolKind: 'include' },
