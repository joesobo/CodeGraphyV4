...
export const e2eScenarios: E2EScenario[] = [
  ...
  },
  {
    ...
    minimumExpectedEdgeIds: [
      'src/index.ts->src/format.ts#import',
      'src/index.ts->src/rollout.ts#import',
      'src/index.ts->src/types.ts#type-import',
      'src/rollout.ts->src/audit.ts#import',
    ],
    ...
    depth: {
      ...
      depthOneEdgeIds: [
        'src/index.ts->src/format.ts#call',
        'src/index.ts->src/format.ts#import',
        'src/index.ts->src/rollout.ts#call',
        'src/index.ts->src/rollout.ts#import',
        'src/index.ts->src/types.ts#type-import',
      ],
      depthTwoNodeIds: [
      ...
      rerootDepthOneEdgeIds: [
        'src/index.ts->src/rollout.ts#call',
        'src/index.ts->src/rollout.ts#import',
        'src/rollout.ts->src/audit.ts#call',
        'src/rollout.ts->src/audit.ts#import',
        'src/rollout.ts->src/config.ts#import',
        'src/rollout.ts->src/evaluator.ts#import',
        'src/rollout.ts->src/types.ts#type-import',
      ],
    },
  },
  {
