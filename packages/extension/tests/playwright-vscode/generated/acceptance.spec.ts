...
test.describe('C# Example', () => {
  test('C# example renders expected file nodes and using relationships', async ({}, testInfo) => {
    ...
    try {
      ...
      await test.step('Then I can see there are 15 nodes and 22 connections', async () => {
        await runAcceptanceStep(context, 'I can see there are 15 nodes and 22 connections', {
          keyword: 'Then',
          text: 'I can see there are 15 nodes and 22 connections',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 21
        });
      });
      ...
      await test.step('And src/Program.cs points to src/Models/DispatchTask.cs', async () => {
        await runAcceptanceStep(context, 'src/Program.cs points to src/Models/DispatchTask.cs', {
          keyword: 'And',
          text: 'src/Program.cs points to src/Models/DispatchTask.cs',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 23
        });
      });
      ...
      await test.step('And src/Program.cs points to src/Models/TaskId.cs', async () => {
        await runAcceptanceStep(context, 'src/Program.cs points to src/Models/TaskId.cs', {
          keyword: 'And',
          text: 'src/Program.cs points to src/Models/TaskId.cs',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 24
        });
      });
      ...
      await test.step('And src/Program.cs points to src/Models/DispatchStatus.cs', async () => {
        await runAcceptanceStep(context, 'src/Program.cs points to src/Models/DispatchStatus.cs', {
          keyword: 'And',
          text: 'src/Program.cs points to src/Models/DispatchStatus.cs',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 25
        });
      });
      ...
      await test.step('And src/Program.cs points to src/Services/PriorityTaskQueue.cs', async () => {
        await runAcceptanceStep(context, 'src/Program.cs points to src/Services/PriorityTaskQueue.cs', {
          keyword: 'And',
          text: 'src/Program.cs points to src/Services/PriorityTaskQueue.cs',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 26
        });
      });
      ...
      await test.step('And src/Contracts/ITaskRunner.cs points to src/Models/DispatchResult.cs', async () => {
        await runAcceptanceStep(context, 'src/Contracts/ITaskRunner.cs points to src/Models/DispatchResult.cs', {
          keyword: 'And',
          text: 'src/Contracts/ITaskRunner.cs points to src/Models/DispatchResult.cs',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 28
        });
      });
      ...
      await test.step('And src/Events/TaskCompleted.cs points to src/Models/DispatchTask.cs', async () => {
        await runAcceptanceStep(context, 'src/Events/TaskCompleted.cs points to src/Models/DispatchTask.cs', {
          keyword: 'And',
          text: 'src/Events/TaskCompleted.cs points to src/Models/DispatchTask.cs',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 29
        });
      });
      ...
      await test.step('Then I can see there are 83 nodes and 0 connections', async () => {
        await runAcceptanceStep(context, 'I can see there are 83 nodes and 0 connections', {
          keyword: 'Then',
          text: 'I can see there are 83 nodes and 0 connections',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 116
        });
      });
      ...
      await test.step('Then I can see there are 83 nodes and 68 connections', async () => {
        await runAcceptanceStep(context, 'I can see there are 83 nodes and 68 connections', {
          keyword: 'Then',
          text: 'I can see there are 83 nodes and 68 connections',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 119
        });
      });
      ...
      await test.step('Then I can see there are 83 nodes and 25 connections', async () => {
        await runAcceptanceStep(context, 'I can see there are 83 nodes and 25 connections', {
          keyword: 'Then',
          text: 'I can see there are 83 nodes and 25 connections',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 130
        });
      });
      ...
      await test.step('And the visible graph shows TaskId in src/Models/DispatchResult.cs referencing type TaskId in src/Models/TaskId.cs', async () => {
        await runAcceptanceStep(context, 'the visible graph shows TaskId in src/Models/DispatchResult.cs referencing type TaskId in src/Models/TaskId.cs', {
          keyword: 'And',
          text: 'the visible graph shows TaskId in src/Models/DispatchResult.cs referencing type TaskId in src/Models/TaskId.cs',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 133
        });
      });
      ...
      await test.step('And the visible graph shows _settings in src/Services/TaskDispatcher.cs referencing type DispatchSettings in src/Config/DispatchSettings.cs', async () => {
        await runAcceptanceStep(context, 'the visible graph shows _settings in src/Services/TaskDispatcher.cs referencing type DispatchSettings in src/Config/DispatchSettings.cs', {
          keyword: 'And',
          text: 'the visible graph shows _settings in src/Services/TaskDispatcher.cs referencing type DispatchSettings in src/Config/DispatchSettings.cs',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 137
        });
      });
      ...
      await test.step('Then I can see there are 83 nodes and 11 connections', async () => {
        await runAcceptanceStep(context, 'I can see there are 83 nodes and 11 connections', {
          keyword: 'Then',
          text: 'I can see there are 83 nodes and 11 connections',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 143
        });
      });
      ...
      await test.step('And the visible graph shows Main in src/Program.cs calling TaskDispatcher in src/Services/TaskDispatcher.cs', async () => {
        await runAcceptanceStep(context, 'the visible graph shows Main in src/Program.cs calling TaskDispatcher in src/Services/TaskDispatcher.cs', {
          keyword: 'And',
          text: 'the visible graph shows Main in src/Program.cs calling TaskDispatcher in src/Services/TaskDispatcher.cs',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 144
        });
      });
      ...
      await test.step('And the visible graph shows Dispatch in src/Services/TaskDispatcher.cs calling Enqueue in src/Contracts/ITaskQueue.cs', async () => {
        await runAcceptanceStep(context, 'the visible graph shows Dispatch in src/Services/TaskDispatcher.cs calling Enqueue in src/Contracts/ITaskQueue.cs', {
          keyword: 'And',
          text: 'the visible graph shows Dispatch in src/Services/TaskDispatcher.cs calling Enqueue in src/Contracts/ITaskQueue.cs',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 146
        });
      });
      ...
      await test.step('Then I can see there are 83 nodes and 1 connection', async () => {
        await runAcceptanceStep(context, 'I can see there are 83 nodes and 1 connection', {
          keyword: 'Then',
          text: 'I can see there are 83 nodes and 1 connection',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 151
        });
      });
      ...
      await test.step('And the visible graph shows TaskDispatcher in src/Services/TaskDispatcher.cs inheriting from BaseTaskRunner in src/Services/BaseTaskRunner.cs', async () => {
        await runAcceptanceStep(context, 'the visible graph shows TaskDispatcher in src/Services/TaskDispatcher.cs inheriting from BaseTaskRunner in src/Services/BaseTaskRunner.cs', {
          keyword: 'And',
          text: 'the visible graph shows TaskDispatcher in src/Services/TaskDispatcher.cs inheriting from BaseTaskRunner in src/Services/BaseTaskRunner.cs',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 152
        });
      });
      ...
      await test.step('Then I can see there are 83 nodes and 2 connections', async () => {
        await runAcceptanceStep(context, 'I can see there are 83 nodes and 2 connections', {
          keyword: 'Then',
          text: 'I can see there are 83 nodes and 2 connections',
          sourcePath: 'tests/acceptance/specs/csharp-example.md',
          line: 155
        });
      });
