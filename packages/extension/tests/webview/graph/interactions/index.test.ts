...
} from '../../../../src/webview/components/graph/interactions';
import {
  clearSentMessages,
  findMessage,
  getSentMessages,
...
describe('graph/interactionHandlers', () => {
  ...
  it('wires the composed handler factories and re-exports their handlers', async () => {
    ...
    vi.doMock('../../../../src/webview/components/graph/interactions/selection', () => ({
      createSelectionHandlers,
    }));
    vi.doMock('../../../../src/webview/components/graph/interactions/contextMenu', () => ({
      createContextMenuHandlers,
    }));
    vi.doMock('../../../../src/webview/components/graph/interactions/view', () => ({
      createViewHandlers,
    }));
    vi.doMock('../../../../src/webview/components/graph/interactions/effects', () => ({
    ...
    const { createGraphInteractionHandlers: createHandlers } = await import(
      '../../../../src/webview/components/graph/interactions'
    );
    const dependencies = createDependencies();
    ...
    vi.doUnmock('../../../../src/webview/components/graph/interactions/selection');
    vi.doUnmock('../../../../src/webview/components/graph/interactions/contextMenu');
