...
if (!descriptor) {
  throw new Error('Unity package is missing its Extension plugin descriptor.');
}

const extensionDescriptor = descriptor;

export function createUnityExtensionPlugin(): IExtensionPlugin {
  return {
...
export default createUnityExtensionPlugin;
