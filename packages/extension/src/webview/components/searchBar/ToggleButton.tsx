/**
 * @fileoverview Small toggle button component for search options (VS Code style).
 */
 ...
 */
export function ToggleButton({ active, onClick, title, shortcut, children, hasError }: ToggleButtonProps): React.ReactElement {
  return (
    <button
      onClick={onClick}
