import { discoverMutationPackageNames } from '../analysis/packages';
...
const extensionNodeTestIncludes = [
  'packages/extension/tests/core/**/*.test.ts',
  'packages/extension/tests/core/**/*.test.tsx',
  ...
  'packages/extension/tests/shared/**/*.test.ts',
  'packages/extension/tests/shared/**/*.test.tsx',
  'packages/extension/tests/*.test.ts',
];

const extensionWebviewTestIncludes = [
  'packages/extension/tests/extension/pluginIntegration/typescript.test.ts',
  'packages/extension/tests/integration/**/*.test.tsx',
  'packages/extension/tests/webview/**/*.test.ts',
  'packages/extension/tests/webview/**/*.test.tsx',
];
