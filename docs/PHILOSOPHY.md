...
- Python, Go, Haskell, Java, Kotlin, Lua, PHP, Ruby, Rust, Swift, Dart, C#, C, and C++: built-in Tree-sitter analysis finds baseline imports, symbols, and low-noise structural relationships, plugins can add richer project-aware semantics
