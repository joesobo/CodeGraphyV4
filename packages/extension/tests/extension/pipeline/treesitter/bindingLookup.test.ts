...
} from '../../../../src/extension/pipeline/plugins/treesitter/runtime/analyze/import/binding/bindingLookup';
...
describe('pipeline/plugins/treesitter/runtime/analyze/import/binding/bindingLookup', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
