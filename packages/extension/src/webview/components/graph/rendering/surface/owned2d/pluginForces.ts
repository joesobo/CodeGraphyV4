...
} from './pluginForceAdapters';
import { forceContextSignature, forceNamespace, visiblePluginForceGraph } from './pluginForceContext';
...
class ActiveOwnedGraphPluginForces implements OwnedGraphPluginForces {
  ...
  tick(alpha?: number): void { tickInstalledForces(this.installed, alpha); }
