...
describe('graphControls/defaults/definitions', () => {
  ...
  it('declares concrete core symbol node type definitions', () => {
    expect(createCoreSymbolNodeTypes()).toEqual([
      ...
      { id: 'symbol:mixin', label: 'Mixin', defaultColor: '#2563EB', defaultVisible: false, parentId: 'symbol', matchSymbolKinds: ['mixin'] },
      { id: 'symbol:extension', label: 'Extension', defaultColor: '#4F46E5', defaultVisible: false, parentId: 'symbol', matchSymbolKinds: ['extension'] },
