...
- Keep implementation plans, investigation notes, decisions, and handoffs in the task, Trello card, or PR. Do not commit plan or handoff documents. Document current behavior in the closest product, package, or developer reference.
