...
import { createDefaultGraphViewProviderAnalysisMethodDependencies } from '../../../src/extension/graphView/providerAnalysisMethods';

describe('graphView/providerAnalysisMethods default dependencies', () => {
  afterEach(() => {
