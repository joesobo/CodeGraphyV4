...
describe('WorkspacePipeline examples workspace', { timeout: 30000 }, () => {
  ...
  it('connects nested example projects when the repo-root examples folder is opened', async () => {
    ...
    const expectedEdgeIds = [
      ...
      'example-c/src/main.c->example-c/src/logger/logger.h#import:include',
      'example-c/src/main.c#main:function->example-c/src/logger/logger.h#logger_init:function#call',
      'example-c/src/main.c#main:function->example-c/src/logger/logger.h#logger_write:function#call',
      'example-c/src/main.c#main:function->example-c/src/logger/logger.h#logger_flush:function#call',
      'example-c/src/logger/logger.c->example-c/src/logger/logger.h#import:include',
      'example-c/src/logger/logger.c->example-c/src/logger/format.h#import:include',
      'example-c/src/logger/logger.c#logger_write:function->example-c/src/logger/format.h#logger_format_line:function#call',
      'example-c/src/logger/format.c->example-c/src/logger/format.h#import:include',
      'example-c/src/logger/format.c#logger_format_line:function->example-c/src/logger/format.h#call',
      'example-c/src/logger/format.h->example-c/src/logger/logger.h#import:include',
