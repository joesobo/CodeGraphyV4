...
describe('WorkspacePipeline examples workspace', { timeout: EXAMPLES_WORKSPACE_TEST_TIMEOUT_MS }, () => {
  ...
  it('connects nested example projects when the repo-root examples folder is opened', async () => {
    ...
    const expectedEdgeIds = [
      ...
      'example-c/src/main.c#logger/logger.h:include->example-c/src/logger/logger.h#include:include',
      ...
      'example-c/src/logger/logger.c#logger.h:include->example-c/src/logger/logger.h#include:include',
      'example-c/src/logger/logger.c#format.h:include->example-c/src/logger/format.h#include:include',
      ...
      'example-c/src/logger/format.c#format.h:include->example-c/src/logger/format.h#include:include',
      'example-c/src/logger/format.c#logger_format_line:function->example-c/src/logger/format.h#logger_level_name:prototype#call',
      'example-c/src/logger/format.h#logger.h:include->example-c/src/logger/logger.h#include:include',
    ...
    const expectedStorySymbolIds = [
      ...
      'example-c/src/main.c#logger/logger.h:include',
