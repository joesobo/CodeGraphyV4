    ...
    const { registry, plugin } = registerPlugin({
      ...
      analyzeFile: vi.fn().mockResolvedValue({
        ...
        relations: [{
          ...
          target: { kind: 'file', path: '/src/utils.ts', pathKind: 'absolute', specifier: './utils' },
        }],
      ...
      relations: [
        {
          ...
          from: { kind: 'file', filePath: '/src/styles.css' },
          target: { kind: 'file', path: '/src/theme.css', pathKind: 'absolute', specifier: './theme.css' },
          specifier: './theme.css',
        },
      ],
    } satisfies IFileAnalysisResult);
        ...
        relations: [
          {
            ...
            from: { kind: 'file', filePath: '/src/app.ts' },
            target: { kind: 'file', path: '/src/high.ts', pathKind: 'absolute', specifier: './utils' },
            specifier: './utils',
          },
        ],
      }),
        ...
        relations: [
          {
            ...
            sourceId: 'shared:import',
            from: { kind: 'file', filePath: '/src/app.ts' },
            target: { kind: 'file', path: '/src/low.ts', pathKind: 'absolute', specifier: './utils' },
            specifier: './utils',
          },
        ],
      }),
      ...
      relations: [
        {
          ...
          sourceId: 'shared:import',
          from: { kind: 'file', filePath: '/src/app.ts' },
          target: { kind: 'file', path: '/src/core.ts', pathKind: 'absolute', specifier: './shared' },
          specifier: './shared',
        },
      ],
    } satisfies IFileAnalysisResult));
        ...
        relations: [
          {
            ...
            sourceId: 'shared:import',
            from: { kind: 'file', filePath: '/src/app.ts' },
            target: { kind: 'file', path: '/src/plugin.ts', pathKind: 'absolute', specifier: './shared' },
            specifier: './shared',
          },
        ],
      }),
