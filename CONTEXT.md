...
| **CodeGraphy Agent Skill** | Token-bounded instructions that teach shell-capable agents when CodeGraphy can replace broad navigation, when to skip it, and when to stop graph calls and inspect source. |
