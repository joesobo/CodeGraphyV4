...
const mocks = vi.hoisted(() => ({
  ...
  createWebviewPanel: vi.fn(() => ({ id: 'panel-1' })),
}));
...
import { createGraphViewProviderWebviewMethods } from '../../../../src/extension/graphView/provider/webview';

describe('graphView/provider/webview default dependencies', () => {
  beforeEach(() => {
