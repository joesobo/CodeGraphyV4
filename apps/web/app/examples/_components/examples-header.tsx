...
export function ExamplesHeader(): React.ReactElement {
  return (
    <PageHero
      ...
      aside={<><span className="font-mono text-[#a8c7ff]">Real source. Real graphs.</span><br />Each example is intentionally compact enough to understand while still exercising meaningful relationships.</>}
